...
This repo contains code from [Master Modern CMake, Unit Testing, Continuous Integration, and More for Your daily C/C++ Workflow](https://www.udemy.com/course/cmake-tests-and-tooling-for-cc-projects/learn/lecture/31688974?start=57#overview) course on Udemy.
...
- When is a good idea to use add_custom_command?
  We want to always run the command when is needed: if we need to generate a file (or more) or regenerate it if something changed in the source folder.
